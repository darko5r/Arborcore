...
.PHONY: hello0-application hello0-core-test hello0-integration-test
...
$(HELLO0_MAIN_OBJ): $(HELLO0_MAIN_SOURCE) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(HELLO0_APPLICATION): $(HELLO0_MAIN_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_MAIN_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
...
hello0-sanitize: $(HELLO0_CORE_SANITIZE_TEST) $(HELLO0_INTEGRATION_SANITIZE_TEST)
	...
	@echo "PASS: HELLO0 ASan/UBSan core and MVC/VIEW/HTTP integration"
...
hello0-gate: hello0-core-test hello0-integration-test hello0-sanitize hello0-live-verify hello0-route-scale-benchmark
	@echo "PASS: complete HELLO0 native, adversarial, sanitizer, live and diagnostic evidence"
