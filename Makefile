...
HELLO0_COMMON_DIR := examples/common
HELLO0_BUILD_DIR := $(BUILD_DIR)/hello0
HELLO0_HEADER := $(HELLO0_DIR)/hello0.h
HELLO0_HOST_HEADER := $(HELLO0_COMMON_DIR)/linux_http_mvc_host.h
...
HELLO0_HOST_SOURCE := $(HELLO0_COMMON_DIR)/linux_http_mvc_host.c
...
HELLO0_HOST_OBJ := $(HELLO0_BUILD_DIR)/linux_http_mvc_host.o
...
$(HELLO0_HOST_OBJ): $(HELLO0_HOST_SOURCE) $(HELLO0_HOST_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(HELLO0_APPLICATION): $(HELLO0_MAIN_OBJ) $(HELLO0_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_MAIN_OBJ) $(HELLO0_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
...
$(HELLO0_HOST_TEST): $(HELLO0_HOST_TEST_OBJ) $(HELLO0_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_HOST_TEST_OBJ) $(HELLO0_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
