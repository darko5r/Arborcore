...
EXAMPLE_COMMON_DIR := examples/common
EXAMPLE_COMMON_BUILD_DIR := $(BUILD_DIR)/examples-common
EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER := $(EXAMPLE_COMMON_DIR)/linux_http_mvc_host.h
EXAMPLE_LINUX_HTTP_MVC_HOST_SOURCE := $(EXAMPLE_COMMON_DIR)/linux_http_mvc_host.c
EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ := $(EXAMPLE_COMMON_BUILD_DIR)/linux_http_mvc_host.o

HELLO0_DIR := examples/hello0
HELLO0_COMMON_DIR := $(EXAMPLE_COMMON_DIR)
HELLO0_BUILD_DIR := $(BUILD_DIR)/hello0
HELLO0_HEADER := $(HELLO0_DIR)/hello0.h
HELLO0_HOST_HEADER := $(EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER)
...
HELLO0_HOST_SOURCE := $(EXAMPLE_LINUX_HTTP_MVC_HOST_SOURCE)
...
HELLO0_CPPFLAGS := $(ARBORCORE_C_CPPFLAGS) -I$(HELLO0_DIR) -I$(HELLO0_COMMON_DIR)
...
$(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ): $(EXAMPLE_LINUX_HTTP_MVC_HOST_SOURCE) $(EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER) | $(EXAMPLE_COMMON_BUILD_DIR)
	$(CC) $(ARBORCORE_C_CPPFLAGS) -I$(EXAMPLE_COMMON_DIR) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(HELLO0_APPLICATION): $(HELLO0_MAIN_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_MAIN_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
...
$(HELLO0_HOST_TEST): $(HELLO0_HOST_TEST_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_HOST_TEST_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
...
$(HELLO0_HOST_SANITIZE_TEST): $(HELLO0_HOST_TEST_SOURCE) $(HELLO0_HOST_SOURCE) $(HELLO0_HOST_HEADER) $(HELLO0_SANITIZE_SOURCES) $(HELLO0_SANITIZE_ASSEMBLY) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(HELLO0_HOST_TEST_SOURCE) $(HELLO0_HOST_SOURCE) $(HELLO0_SANITIZE_SOURCES) \
		$(HELLO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@
...
ECHO0_CPPFLAGS := $(ARBORCORE_C_CPPFLAGS) -I$(ECHO0_DIR) -I$(EXAMPLE_COMMON_DIR)
...
$(ECHO0_MAIN_OBJ): $(ECHO0_MAIN_SOURCE) $(ECHO0_HEADER) $(EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(ECHO0_HOST_TEST_OBJ): $(ECHO0_HOST_TEST_SOURCE) $(ECHO0_HEADER) $(EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(ECHO0_ROUTE_SCALE_OBJ): $(ECHO0_ROUTE_SCALE_SOURCE) | $(ECHO0_BUILD_DIR)
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(ECHO0_APPLICATION): $(ECHO0_MAIN_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_MAIN_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
...
$(ECHO0_HOST_TEST): $(ECHO0_HOST_TEST_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_HOST_TEST_OBJ) $(EXAMPLE_LINUX_HTTP_MVC_HOST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
...
$(ECHO0_HOST_SANITIZE_TEST): $(ECHO0_HOST_TEST_SOURCE) $(EXAMPLE_LINUX_HTTP_MVC_HOST_SOURCE) $(EXAMPLE_LINUX_HTTP_MVC_HOST_HEADER) $(ECHO0_SANITIZE_SOURCES) $(ECHO0_SANITIZE_ASSEMBLY) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(ECHO0_HOST_TEST_SOURCE) $(EXAMPLE_LINUX_HTTP_MVC_HOST_SOURCE) $(ECHO0_SANITIZE_SOURCES) \
		$(ECHO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@
...
echo0-sanitize: $(ECHO0_CORE_SANITIZE_TEST) $(ECHO0_INTEGRATION_SANITIZE_TEST) $(ECHO0_HOST_SANITIZE_TEST)
	...
	@echo "PASS: ECHO0 ASan/UBSan core, integration and private-host evidence"
