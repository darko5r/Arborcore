...
# ============================================================
# HELLO0 — complete native MVC + VIEW0 loopback application
# ============================================================

HOST1_BUILD_DIR := $(BUILD_DIR)/host1
HOST1_HEADER := include/arborcore/linux_http_mvc_host.h
HOST1_SOURCE := src/c/linux_http_mvc_host.c
HOST1_OBJ := $(HOST1_BUILD_DIR)/linux_http_mvc_host.o
HOST1_LIB := $(BUILD_DIR)/libarborcore_host1.a
HOST1_SANITIZE_OBJ := $(HOST1_BUILD_DIR)/linux_http_mvc_host_sanitize.o
HOST1_SANITIZE_LIB := $(HOST1_BUILD_DIR)/libarborcore_host1_sanitize.a
HOST1_PUBLIC_CONSUMER_SOURCE := tests/c/linux_http_mvc_host_public_consumer_test.c
HOST1_PUBLIC_CONSUMER_OBJ := $(HOST1_BUILD_DIR)/public_consumer_test.o
...
HELLO0_HOST_HEADER := $(HOST1_HEADER)
HELLO0_TEMPLATE := $(HELLO0_DIR)/page.html
HELLO0_APPLICATION_SOURCE := $(HELLO0_DIR)/application.c
HELLO0_WEB_SOURCE := $(HELLO0_DIR)/web.c
HELLO0_MAIN_SOURCE := $(HELLO0_DIR)/main.c
HELLO0_CORE_TEST_SOURCE := tests/c/hello0_core_test.c
HELLO0_INTEGRATION_TEST_SOURCE := tests/c/hello0_integration_test.c
HELLO0_HOST_TEST_SOURCE := tests/c/hello0_host_test.c
HELLO0_ROUTE_SCALE_SOURCE := bench/hello0_route_scale_bench.c
HELLO0_LIVE_VERIFY := tools/hello0_live_verify.sh

HELLO0_APPLICATION_OBJ := $(HELLO0_BUILD_DIR)/application.o
HELLO0_WEB_OBJ := $(HELLO0_BUILD_DIR)/web.o
HELLO0_MAIN_OBJ := $(HELLO0_BUILD_DIR)/main.o
HELLO0_CORE_TEST_OBJ := $(HELLO0_BUILD_DIR)/core_test.o
HELLO0_INTEGRATION_TEST_OBJ := $(HELLO0_BUILD_DIR)/integration_test.o
HELLO0_HOST_TEST_OBJ := $(HELLO0_BUILD_DIR)/host_test.o
HELLO0_ROUTE_SCALE_OBJ := $(HELLO0_BUILD_DIR)/route_scale_bench.o

HELLO0_APPLICATION := $(HELLO0_BUILD_DIR)/hello0
HELLO0_CORE_TEST := $(HELLO0_BUILD_DIR)/core-test
HELLO0_INTEGRATION_TEST := $(HELLO0_BUILD_DIR)/integration-test
HELLO0_HOST_TEST := $(HELLO0_BUILD_DIR)/host-test
HELLO0_CORE_SANITIZE_TEST := $(HELLO0_BUILD_DIR)/core-sanitize-test
HELLO0_INTEGRATION_SANITIZE_TEST := $(HELLO0_BUILD_DIR)/integration-sanitize-test
HELLO0_HOST_SANITIZE_TEST := $(HELLO0_BUILD_DIR)/host-sanitize-test
HELLO0_ROUTE_SCALE_BENCH := $(HELLO0_BUILD_DIR)/route-scale-bench

HELLO0_CPPFLAGS := $(ARBORCORE_C_CPPFLAGS) -I$(HELLO0_DIR)
HELLO0_COMMON_OBJS := $(HELLO0_APPLICATION_OBJ) $(HELLO0_WEB_OBJ)
HELLO0_LIBRARIES := \
	$(VIEW0_C1_LIB) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) \
	$(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)
HELLO0_SANITIZE_SOURCES := \
	$(HELLO0_APPLICATION_SOURCE) $(HELLO0_WEB_SOURCE) \
	$(VIEW0_C1_SOURCE) $(HTTP1_C_SOURCE) $(MVC0_C_SOURCE) \
	$(APPLICATION_FOUNDATION_SOURCE) $(HTTP0_C_SOURCE) $(C_RUNTIME_SOURCES)
HELLO0_SANITIZE_ASSEMBLY := \
	$(MVC0_ASM_OBJ) $(HTTP0_HEADER_ASM_OBJ) $(HTTP0_RESPONSE_ASM_OBJ) $(STATIC_LIB)
...
$(HOST1_LIB): $(HOST1_OBJ) | $(BUILD_DIR)
	$(AR) rcsD $@ $<

$(HOST1_SANITIZE_OBJ): $(HOST1_SOURCE) $(HOST1_HEADER) | $(HOST1_BUILD_DIR)
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer -c $< -o $@

$(HOST1_SANITIZE_LIB): $(HOST1_SANITIZE_OBJ) | $(HOST1_BUILD_DIR)
	$(AR) rcsD $@ $<

$(HELLO0_CORE_TEST_OBJ): $(HELLO0_CORE_TEST_SOURCE) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(HELLO0_INTEGRATION_TEST_OBJ): $(HELLO0_INTEGRATION_TEST_SOURCE) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(HELLO0_HOST_TEST_OBJ): $(HELLO0_HOST_TEST_SOURCE) $(HELLO0_HEADER) $(HELLO0_HOST_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(HELLO0_CORE_TEST): $(HELLO0_CORE_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_CORE_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)

hello0-core-test: $(HELLO0_CORE_TEST)
	@$(HELLO0_CORE_TEST)

$(HELLO0_INTEGRATION_TEST): $(HELLO0_INTEGRATION_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_INTEGRATION_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HELLO0_LIBRARIES)

hello0-integration-test: $(HELLO0_INTEGRATION_TEST)
	@$(HELLO0_INTEGRATION_TEST)

$(HELLO0_HOST_TEST): $(HELLO0_HOST_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_HOST_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) $(HELLO0_LIBRARIES)

hello0-host-test: $(HELLO0_HOST_TEST)
	@$(HELLO0_HOST_TEST)

$(HELLO0_CORE_SANITIZE_TEST): $(HELLO0_CORE_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) $(HELLO0_SANITIZE_ASSEMBLY) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(HELLO0_CORE_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) \
		$(HELLO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

$(HELLO0_INTEGRATION_SANITIZE_TEST): $(HELLO0_INTEGRATION_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) $(HELLO0_SANITIZE_ASSEMBLY) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(HELLO0_INTEGRATION_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) \
		$(HELLO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

$(HELLO0_HOST_SANITIZE_TEST): $(HELLO0_HOST_TEST_SOURCE) $(HOST1_SANITIZE_LIB) $(HELLO0_HOST_HEADER) $(HELLO0_SANITIZE_SOURCES) $(HELLO0_SANITIZE_ASSEMBLY) $(HELLO0_HEADER) | $(HELLO0_BUILD_DIR)
	$(CC) $(HELLO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(HELLO0_HOST_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) $(HOST1_SANITIZE_LIB) \
		$(HELLO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

hello0-sanitize: $(HELLO0_CORE_SANITIZE_TEST) $(HELLO0_INTEGRATION_SANITIZE_TEST) $(HELLO0_HOST_SANITIZE_TEST)
...
$(HELLO0_ROUTE_SCALE_BENCH): $(HELLO0_ROUTE_SCALE_OBJ) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) $(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HELLO0_ROUTE_SCALE_OBJ) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) \
		$(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)

hello0-route-scale-benchmark: $(HELLO0_ROUTE_SCALE_BENCH)
...
ECHO0_BUILD_DIR := $(BUILD_DIR)/echo0
ECHO0_HEADER := $(ECHO0_DIR)/echo0.h
ECHO0_TEMPLATE := $(ECHO0_DIR)/page.html
ECHO0_APPLICATION_SOURCE := $(ECHO0_DIR)/application.c
ECHO0_WEB_SOURCE := $(ECHO0_DIR)/web.c
ECHO0_MAIN_SOURCE := $(ECHO0_DIR)/main.c
ECHO0_CORE_TEST_SOURCE := tests/c/echo0_core_test.c
ECHO0_INTEGRATION_TEST_SOURCE := tests/c/echo0_integration_test.c
ECHO0_HOST_TEST_SOURCE := tests/c/echo0_host_test.c
ECHO0_ROUTE_SCALE_SOURCE := bench/echo0_route_scale_bench.c
ECHO0_LIVE_VERIFY := tools/echo0_live_verify.sh

ECHO0_APPLICATION_OBJ := $(ECHO0_BUILD_DIR)/application.o
ECHO0_WEB_OBJ := $(ECHO0_BUILD_DIR)/web.o
ECHO0_MAIN_OBJ := $(ECHO0_BUILD_DIR)/main.o
ECHO0_CORE_TEST_OBJ := $(ECHO0_BUILD_DIR)/core_test.o
ECHO0_INTEGRATION_TEST_OBJ := $(ECHO0_BUILD_DIR)/integration_test.o
ECHO0_HOST_TEST_OBJ := $(ECHO0_BUILD_DIR)/host_test.o
ECHO0_ROUTE_SCALE_OBJ := $(ECHO0_BUILD_DIR)/route_scale_bench.o

ECHO0_APPLICATION := $(ECHO0_BUILD_DIR)/echo0
ECHO0_CORE_TEST := $(ECHO0_BUILD_DIR)/core-test
ECHO0_INTEGRATION_TEST := $(ECHO0_BUILD_DIR)/integration-test
ECHO0_HOST_TEST := $(ECHO0_BUILD_DIR)/host-test
ECHO0_CORE_SANITIZE_TEST := $(ECHO0_BUILD_DIR)/core-sanitize-test
ECHO0_INTEGRATION_SANITIZE_TEST := $(ECHO0_BUILD_DIR)/integration-sanitize-test
ECHO0_HOST_SANITIZE_TEST := $(ECHO0_BUILD_DIR)/host-sanitize-test
ECHO0_ROUTE_SCALE_BENCH := $(ECHO0_BUILD_DIR)/route-scale-bench

ECHO0_CPPFLAGS := $(ARBORCORE_C_CPPFLAGS) -I$(ECHO0_DIR)
ECHO0_COMMON_OBJS := $(ECHO0_APPLICATION_OBJ) $(ECHO0_WEB_OBJ)
ECHO0_LIBRARIES := \
	$(VIEW0_C1_LIB) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) \
	$(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)
ECHO0_SANITIZE_SOURCES := \
	$(ECHO0_APPLICATION_SOURCE) $(ECHO0_WEB_SOURCE) \
	$(VIEW0_C1_SOURCE) $(HTTP1_C_SOURCE) $(MVC0_C_SOURCE) \
	$(APPLICATION_FOUNDATION_SOURCE) $(HTTP0_C_SOURCE) $(C_RUNTIME_SOURCES)
ECHO0_SANITIZE_ASSEMBLY := \
	$(MVC0_ASM_OBJ) $(HTTP0_HEADER_ASM_OBJ) $(HTTP0_RESPONSE_ASM_OBJ) $(STATIC_LIB)

.PHONY: echo0-application echo0-core-test echo0-integration-test echo0-host-test
.PHONY: echo0-analyzer echo0-sanitize echo0-live-verify
.PHONY: echo0-route-scale-benchmark echo0-gate

$(ECHO0_BUILD_DIR):
	mkdir -p $@

$(ECHO0_APPLICATION_OBJ): $(ECHO0_APPLICATION_SOURCE) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
...
$(ECHO0_INTEGRATION_TEST_OBJ): $(ECHO0_INTEGRATION_TEST_SOURCE) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(ECHO0_HOST_TEST_OBJ): $(ECHO0_HOST_TEST_SOURCE) $(ECHO0_HEADER) $(HOST1_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@
...
$(ECHO0_CORE_TEST): $(ECHO0_CORE_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_CORE_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)

echo0-core-test: $(ECHO0_CORE_TEST)
	@$(ECHO0_CORE_TEST)

$(ECHO0_INTEGRATION_TEST): $(ECHO0_INTEGRATION_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_INTEGRATION_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(ECHO0_LIBRARIES)

echo0-integration-test: $(ECHO0_INTEGRATION_TEST)
	@$(ECHO0_INTEGRATION_TEST)

$(ECHO0_HOST_TEST): $(ECHO0_HOST_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(HOST1_LIB) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_HOST_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(HOST1_LIB) $(ECHO0_LIBRARIES)

echo0-host-test: $(ECHO0_HOST_TEST)
	@$(ECHO0_HOST_TEST)

echo0-analyzer:
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(ECHO0_APPLICATION_SOURCE)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(ECHO0_WEB_SOURCE)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(ECHO0_MAIN_SOURCE)
	$(CC) $(ECHO0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(ECHO0_CORE_TEST_SOURCE)
	...
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(HOST1_SOURCE)
	@echo "PASS: ECHO0 and public HOST1 GCC analyzer review"
...
$(ECHO0_CORE_SANITIZE_TEST): $(ECHO0_CORE_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) $(ECHO0_SANITIZE_ASSEMBLY) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(ECHO0_CORE_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) \
		$(ECHO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

$(ECHO0_INTEGRATION_SANITIZE_TEST): $(ECHO0_INTEGRATION_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) $(ECHO0_SANITIZE_ASSEMBLY) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(ECHO0_INTEGRATION_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) \
		$(ECHO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

$(ECHO0_HOST_SANITIZE_TEST): $(ECHO0_HOST_TEST_SOURCE) $(HOST1_SANITIZE_LIB) $(HOST1_HEADER) $(ECHO0_SANITIZE_SOURCES) $(ECHO0_SANITIZE_ASSEMBLY) $(ECHO0_HEADER) | $(ECHO0_BUILD_DIR)
	$(CC) $(ECHO0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(ECHO0_HOST_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) $(HOST1_SANITIZE_LIB) \
		$(ECHO0_SANITIZE_ASSEMBLY) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

echo0-sanitize: $(ECHO0_CORE_SANITIZE_TEST) $(ECHO0_INTEGRATION_SANITIZE_TEST) $(ECHO0_HOST_SANITIZE_TEST)
	@ASAN_OPTIONS=detect_leaks=0:halt_on_error=1 UBSAN_OPTIONS=halt_on_error=1 $(ECHO0_CORE_SANITIZE_TEST)
	@ASAN_OPTIONS=detect_leaks=0:halt_on_error=1 UBSAN_OPTIONS=halt_on_error=1 $(ECHO0_INTEGRATION_SANITIZE_TEST)
	@ASAN_OPTIONS=detect_leaks=0:halt_on_error=1 UBSAN_OPTIONS=halt_on_error=1 $(ECHO0_HOST_SANITIZE_TEST)
	@echo "PASS: ECHO0 ASan/UBSan core, integration and public-host evidence"

echo0-live-verify: $(ECHO0_APPLICATION) $(ECHO0_TEMPLATE) $(ECHO0_LIVE_VERIFY)
	@ARBORCORE_ROOT=$(ROOT_DIR) bash $(ECHO0_LIVE_VERIFY)

$(ECHO0_ROUTE_SCALE_BENCH): $(ECHO0_ROUTE_SCALE_OBJ) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) $(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(ECHO0_ROUTE_SCALE_OBJ) $(HTTP1_LIB) $(MVC0_LIB) $(HTTP0_LIB) \
		$(APPLICATION_FOUNDATION_LIB) $(C_RUNTIME_LIB) $(STATIC_LIB)

echo0-route-scale-benchmark: $(ECHO0_ROUTE_SCALE_BENCH)
...
# ============================================================
# LIFE0-R0 — public Linux host lifecycle and deadline drain
# ============================================================
...
LIFE0_CPPFLAGS := \
	$(ARBORCORE_C_CPPFLAGS) -I$(HELLO0_DIR) -I$(ECHO0_DIR)
...
$(LIFE0_LIFECYCLE_TEST_OBJ): $(LIFE0_LIFECYCLE_TEST_SOURCE) $(HELLO0_HEADER) $(HOST1_HEADER) | $(LIFE0_BUILD_DIR)
	$(CC) $(LIFE0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(LIFE0_ADVERSARIAL_TEST_OBJ): $(LIFE0_ADVERSARIAL_TEST_SOURCE) $(ECHO0_HEADER) $(HOST1_HEADER) | $(LIFE0_BUILD_DIR)
	$(CC) $(LIFE0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(LIFE0_SHUTDOWN_BENCH_OBJ): $(LIFE0_SHUTDOWN_BENCH_SOURCE) $(HELLO0_HEADER) $(HOST1_HEADER) | $(LIFE0_BUILD_DIR)
	$(CC) $(LIFE0_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(LIFE0_LIFECYCLE_TEST): $(LIFE0_LIFECYCLE_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(LIFE0_LIFECYCLE_TEST_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) \
		$(HELLO0_LIBRARIES)

life0-native-test: $(LIFE0_LIFECYCLE_TEST)
	@$(LIFE0_LIFECYCLE_TEST)

$(LIFE0_ADVERSARIAL_TEST): $(LIFE0_ADVERSARIAL_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(HOST1_LIB) $(ECHO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(LIFE0_ADVERSARIAL_TEST_OBJ) $(ECHO0_COMMON_OBJS) $(HOST1_LIB) \
		$(ECHO0_LIBRARIES)
...
$(LIFE0_LIFECYCLE_SANITIZE_TEST): $(LIFE0_LIFECYCLE_TEST_SOURCE) $(HOST1_SANITIZE_LIB) $(HOST1_HEADER) $(HELLO0_SANITIZE_SOURCES) $(HELLO0_SANITIZE_ASSEMBLY) $(HELLO0_HEADER) | $(LIFE0_BUILD_DIR)
	$(CC) $(LIFE0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(LIFE0_LIFECYCLE_TEST_SOURCE) $(HELLO0_SANITIZE_SOURCES) \
		$(HOST1_SANITIZE_LIB) $(HELLO0_SANITIZE_ASSEMBLY) \
		$(ARBORCORE_C_LDFLAGS) -fsanitize=address,undefined -o $@

$(LIFE0_ADVERSARIAL_SANITIZE_TEST): $(LIFE0_ADVERSARIAL_TEST_SOURCE) $(HOST1_SANITIZE_LIB) $(HOST1_HEADER) $(ECHO0_SANITIZE_SOURCES) $(ECHO0_SANITIZE_ASSEMBLY) $(ECHO0_HEADER) | $(LIFE0_BUILD_DIR)
	$(CC) $(LIFE0_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(LIFE0_ADVERSARIAL_TEST_SOURCE) $(ECHO0_SANITIZE_SOURCES) \
		$(HOST1_SANITIZE_LIB) $(ECHO0_SANITIZE_ASSEMBLY) \
		$(ARBORCORE_C_LDFLAGS) -fsanitize=address,undefined -o $@
...
$(LIFE0_SHUTDOWN_BENCH): $(LIFE0_SHUTDOWN_BENCH_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(LIFE0_SHUTDOWN_BENCH_OBJ) $(HELLO0_COMMON_OBJS) $(HOST1_LIB) \
		$(HELLO0_LIBRARIES)
...
# ============================================================
# HOST1-R0 — public Linux HTTP/MVC host promotion
# ============================================================

$(HOST1_PUBLIC_CONSUMER_OBJ): $(HOST1_PUBLIC_CONSUMER_SOURCE) $(HOST1_HEADER) | $(HOST1_BUILD_DIR)
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -c $< -o $@

$(HOST1_PUBLIC_CONSUMER_TEST): $(HOST1_PUBLIC_CONSUMER_OBJ) $(HOST1_LIB) $(HELLO0_LIBRARIES)
	$(CC) $(ARBORCORE_C_LDFLAGS) -o $@ \
		$(HOST1_PUBLIC_CONSUMER_OBJ) $(HOST1_LIB) $(HELLO0_LIBRARIES)

host1-public-consumer-test: $(HOST1_PUBLIC_CONSUMER_TEST)
	@$(HOST1_PUBLIC_CONSUMER_TEST)

host1-analyzer: life0-analyzer
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(ARBORCORE_C_CFLAGS) -fanalyzer -fsyntax-only $(HOST1_PUBLIC_CONSUMER_SOURCE)
	@echo "PASS: HOST1 source and eight public consumers pass GCC analyzer review"

$(HOST1_PUBLIC_CONSUMER_SANITIZE_TEST): $(HOST1_PUBLIC_CONSUMER_SOURCE) $(HOST1_SANITIZE_LIB) $(HOST1_HEADER) $(HELLO0_SANITIZE_ASSEMBLY) | $(HOST1_BUILD_DIR)
	$(CC) $(ARBORCORE_C_CPPFLAGS) $(filter-out -O2,$(ARBORCORE_C_CFLAGS)) -O1 -g \
		-fsanitize=address,undefined -fno-omit-frame-pointer \
		$(HOST1_PUBLIC_CONSUMER_SOURCE) $(HOST1_SANITIZE_LIB) \
		$(HELLO0_LIBRARIES) $(ARBORCORE_C_LDFLAGS) \
		-fsanitize=address,undefined -o $@

host1-sanitize: $(HOST1_PUBLIC_CONSUMER_SANITIZE_TEST)
	@ASAN_OPTIONS=detect_leaks=0:halt_on_error=1 UBSAN_OPTIONS=halt_on_error=1 $(HOST1_PUBLIC_CONSUMER_SANITIZE_TEST)
	@echo "PASS: HOST1 public consumer ASan/UBSan evidence"
