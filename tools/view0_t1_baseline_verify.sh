...
echo 'VIEW0_T1_ASSEMBLY_ABI_V1_REOPEN=NO'
echo 'VIEW0_T1_AF1_AF4_REOPEN=NO'
echo 'VIEW0_T1_MVC0_REOPEN=NO'
echo 'VIEW0_T1_HTTP0_REOPEN=NO'
echo 'VIEW0_T1_HTTP1_REOPEN=NO'
echo 'VIEW0_T1_BROWSER_AUTHORITY_REOPEN=NO'
echo 'PASS: VIEW0 T1 composes over the exact frozen HTTP1 base without dependency reopen'
