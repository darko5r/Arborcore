...
echo 'VIEW0_C1_ASSEMBLY_ABI_V1_REOPEN=NO'
echo 'VIEW0_C1_AF1_AF4_REOPEN=NO'
echo 'VIEW0_C1_MVC0_REOPEN=NO'
echo 'VIEW0_C1_HTTP0_REOPEN=NO'
echo 'VIEW0_C1_HTTP1_REOPEN=NO'
echo 'VIEW0_C1_BROWSER_AUTHORITY_REOPEN=NO'
echo 'PASS: VIEW0 C1 exact HTTP1 base and frozen dependency authority'
