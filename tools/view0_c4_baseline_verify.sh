...
echo 'VIEW0_C4_ASSEMBLY_ABI_V1_REOPEN=NO'
echo 'VIEW0_C4_AF1_AF4_REOPEN=NO'
echo 'VIEW0_C4_MVC0_REOPEN=NO'
echo 'VIEW0_C4_HTTP0_REOPEN=NO'
echo 'VIEW0_C4_HTTP1_REOPEN=NO'
echo 'VIEW0_C4_BROWSER_AUTHORITY_REOPEN=NO'
echo 'PASS: VIEW0 C4 is a test-only NASM consumer over exact frozen dependencies'
