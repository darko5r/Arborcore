...
production_text_bytes="$(arborcore_production_text_bytes "$ROOT")"
production_source_sha256="$(arborcore_production_source_sha256 "$ROOT")"
memory_policy_sha256="$(arborcore_memory_policy_sha256 "$ROOT")"
memory_copy_qword_min="$(arborcore_memory_policy_qword_min "$ROOT")"
memory_copy_rep_min="$(arborcore_memory_policy_rep_min "$ROOT")"

{
    ...
    echo "production_text_bytes=$production_text_bytes"
    echo "production_tree_state=$production_tree_state"
    echo "production_source_sha256=$production_source_sha256"
    echo "memory_policy_sha256=$memory_policy_sha256"
    echo "memory_copy_qword_min=$memory_copy_qword_min"
    echo "memory_copy_rep_min=$memory_copy_rep_min"
