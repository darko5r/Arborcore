...
echo 'VIEW0_C2_ASSEMBLY_ABI_V1_REOPEN=NO'
echo 'VIEW0_C2_AF1_AF4_REOPEN=NO'
echo 'VIEW0_C2_MVC0_REOPEN=NO'
echo 'VIEW0_C2_HTTP0_REOPEN=NO'
echo 'VIEW0_C2_HTTP1_REOPEN=NO'
echo 'VIEW0_C2_BROWSER_AUTHORITY_REOPEN=NO'
echo 'PASS: VIEW0 C2 composes over exact frozen HTTP1 base without dependency reopen'
