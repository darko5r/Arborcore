...
echo 'VIEW0_M1_ASSEMBLY_ABI_V1_REOPEN=NO'
echo 'VIEW0_M1_AF1_AF4_REOPEN=NO'
echo 'VIEW0_M1_MVC0_REOPEN=NO'
echo 'VIEW0_M1_HTTP0_REOPEN=NO'
echo 'VIEW0_M1_HTTP1_REOPEN=NO'
echo 'VIEW0_M1_BROWSER_AUTHORITY_REOPEN=NO'
echo 'PASS: VIEW0 M1 composes over exact frozen MVC0/HTTP0/HTTP1 dependencies without reopening them'
